...
insert into User_Patronage(user_id, patronage_id) values(2, 42);
insert into User_Patronage(user_id, patronage_id) values(3, 43);
insert into User_Patronage(user_id, patronage_id) values(4, 44);
