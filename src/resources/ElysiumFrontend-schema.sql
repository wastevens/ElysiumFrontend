...
create table PlayerCharacter (id varchar(255) not null, bloodline integer, clan integer, deleted_at datetime, mental_attribute integer, name varchar(255), physical_attribute integer, primary_necromantic_path integer, primary_thaumaturgical_path integer, social_attribute integer, xp integer, primary key (id));
...
alter table Troupe_PlayerCharacters add constraint UK_53srvok8crl3cn9t06rugjlcp  unique (playerCharacter_id);
alter table Troupe_StorytellerUsers add constraint UK_90ql28cp9hd4k7yuw3so71t6v  unique (user_id);
alter table User_PlayerCharacters add constraint UK_1ysplr41o96bp9jx554y51qqy  unique (playerCharacter_id);
