...
alter table Patronage drop foreign key Patronage_User_FK;
...
create table Patronage (id integer not null, expiration datetime, year integer, user_id integer, primary key (id));
...
alter table Patronage add constraint Patronage_User_FK foreign key (user_id) references User (id);
