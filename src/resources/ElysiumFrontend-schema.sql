...
alter table User drop foreign key User_Patronage_FK;
...
create table User (id integer not null, email varchar(255), firstName varchar(255), lastName varchar(255), password varchar(255), patronage_id integer, primary key (id));
...
alter table User add constraint User_Patronage_FK foreign key (patronage_id) references Patronage (id);
