...
alter table PlayerCharacterOwnership drop foreign key PlayerCharacterOwnership_PlayerCharacter_FK;
alter table PlayerCharacterOwnership drop foreign key PlayerCharacterOwnership_User_FK;
alter table PlayerCharacterOwnership_statusChanges drop foreign key FK_634bae9tq2au78wsfr3uq7f4e;
...
alter table User_PlayerCharacterOwnership drop foreign key PlayerCharacterOwnerships_User_FK;
alter table User_PlayerCharacterOwnership drop foreign key User_PlayerCharacterOwnerships_FK;
...
drop table if exists PlayerCharacterOwnership;
drop table if exists PlayerCharacterOwnership_statusChanges;
...
drop table if exists User_PlayerCharacterOwnership;
...
alter table PlayerCharacterOwnership add constraint PlayerCharacterOwnership_User_FK foreign key (user_id) references User (id);
